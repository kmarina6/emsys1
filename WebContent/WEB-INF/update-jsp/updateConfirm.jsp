...
<table>
<tr><td align="right">社員番号：</td><td><%= updateUser.getEmpNoAfter()%></td></tr>
<tr><td align="right">氏名：</td><td><%= updateUser.getEmpName()%></td></tr>
<tr><td align="right">よみかな：</td><td><%= updateUser.getEmpKana()%></td></tr>
<tr><td align="right">入社日：</td><td><%= updateUser.getHireYmd().replaceAll("-","/").replaceAll("null","")%></td></tr>
<tr><td align="right">退職日：</td><td><%= updateUser.getRetirementYmd().replaceAll("-","/").replaceAll("null","")%></td></tr>

<tr><td align="right">所属部署：</td><td><%= updateUser.getDepartmentData().replaceAll("null","")%></td></tr>
